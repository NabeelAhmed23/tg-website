...
export default class HeroSection extends Component {
    ...
    render() {
        return (
            <section className='hero-bg h-[29rem] bg-no-repeat bg-cover sm:bg-center md:h-[30rem] lg:h-[36rem] xl:h-[40rem] 2xl:h-[46rem] relative' >
                <div className='pt-14 md:pt-20 lg:pt-28 xl:pt-32 2xl:pt-40 px-3 md:px-6 lg:pl-14 2xl:pl-20 w-8/12 sm:w-7/12  xl:w-6/12 blur-background h-full '>
                    <div className=' max-w-[35rem]'>
                        <h1 className='text-white text-2xl md:text-4xl lg:text-5xl xl:text-6xl lg:leading-tight 2xl:leading-[76px] font-semibold text-shadow'>The World&apos;s Best <br /> Gay Travel Guide</h1>
                        <p className='text-xs max-w-[14rem] md:max-w-[24rem] lg:max-w-[30rem] lg:text-base leading-5 text-white text-shadow mt-2 lg:mt-4 xl:mt-6 2xl:mt-8'>Find the best gay bars gay hotels
                    ...
                    <div className='-mx-3 md:-mx-6 lg:-ml-14 2xl:-ml-20 w-screen lg:w-screen relative'>
                        <div className='pl-3 md:pl-6 lg:pl-14 2xl:pl-20 w-max'>
                            <h2 className='text-white mt-14 2xl:mt-20 font-semibold'>Top Hotels</h2>
