...
export default class FeaturedNews extends Component {
    render() {
        return (
            <section className='py-10 theme-x-padding lg:py-16 xl:py-20'>
                <div className='grid grid-cols-1 lg:grid-cols-[20rem_1fr] gap-4'>
                    <div>
                        <h1 className='text-xl font-bold text-primary max-w-[19.5rem] xl:text-[1.75rem] xl:leading-10 sm:max-w-none'>Gay Travel News, Interviews & Features</h1>
                        ...
                        <Link href="#"><a className='text-primary mt-4 hidden md:inline-block underline font-semibold'> View All Update </a></Link>
                    </div>
                            ...
                            <SplideSlide>
                                <div className='relative'>
                                    ...
                                    <div className='mt-3'>
                                        ...
                                        <h2 className='mt-1 font-bold xl:text-lg'>Tom Prior On Gay Travel, Mindfulness Firebird</h2>
                                    </div>
                                </div>
                            </SplideSlide>
                            <SplideSlide>
