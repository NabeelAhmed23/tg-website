    ...
    render() {
        return (
            <section className='mt-[160px] lg:mt-0 lg:pl-[14vw]'>
                <div className='px-3 py-4 md:px-[14vw] bg-secondary relative grid grid-cols-1 lg:grid-cols-2 lg:px-0 lg:gap-6 lg:py-10 rounded-l lg:min-h-[500px]'>
                    ...
                    <div className='-mt-36 lg:mt-0 lg:w-10/12 xl:w-7/12'>
                        <h2 className='text-primary font-bold text-xl'>Gay Travel Made Easy</h2>
