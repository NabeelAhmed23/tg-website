    ...
    <>
      {smFormOpen && (
        <div
          ...
          className="fixed z-20 inset-0 bg-[rgba(0,0,0,0.5)]"
      ...
      <div
        className={`fixed lg:relative -bottom-1 lg:bottom-auto transition-all ${
          smFormOpen ? " h-[480px] z-30" : " h-[44px] z-10"
        } inset-x-0`}
      >
        <div className="">
          <button
        ...
        <div
          className={`${
            smFormOpen ? "h-[436px]" : "h-0 md:h-auto"
          ...
          <div
            className={`transition-all duration-700 ${
              scrolled
                ...
                : "relative md:absolute top-auto left-auto right-auto lg:-top-24 md:left-0 md:right-0 w-full max-w-[100%]  lg:max-w-[960px] xl:max-w-[1140px] 2xl:max-w-[1313px] mx-auto md:shadow-lg lg:rounded-md  py-6 md:py-6 xl:py-6 px-4 md:px-10 lg:px-6 xl:px-8 2xl:px-10"
            } bg-primary`}
          >
